<div class="dt-breadcrumb">
  <a href="..">Home</a> &rsaquo; Get started &rsaquo; Use cases
</div>

# Use cases

With the ingested Kyverno security event data, you can accomplish various use cases.

## Visualize and analyze security findings

Create dashboards that show the compliance posture of your Kubernetes clusters at a glance. Typical views include:
...
- **Remediation** — trigger Kubernetes actions (e.g., annotate or label non-compliant resources) via workflow integrations
- **Compliance reporting** — generate periodic compliance summary reports and distribute them to stakeholders
...
- **Cross-reference** container image vulnerabilities (from ECR, Harbor, or other scanners) with Kyverno image verification failures
